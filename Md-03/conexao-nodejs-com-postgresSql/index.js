...
app.get('/', async (req, res) => {
    ...
    try {
        ...
        // const query = `
        // select e.id as id_empresa, f.id as id_filial, e.nome, f.pais, p.nome as funcionarios 
        // from empresas e 
        ...
        // const query = `
        // select e.id as empreasID, f.id as filialID, e.nome, f.pais from empresas e left join filiais f on e.id = f.empresa_id;
        // `
